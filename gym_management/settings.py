...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-manual-creation-temporary-key')
...
MIDDLEWARE = [
    ...
    'core.middleware.TenantMiddleware',  # Custom tenant isolation
]
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Enterprise SaaS Gym Management Platform API',
    'VERSION': '3.0.0',
